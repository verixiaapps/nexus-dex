...
//
// CHANGES (visual-plumbing only — all trading/RPC logic preserved):
//   • CSS combined inline as MW_CSS + useMwCSS injector (no MemeWonderland.css)
...
.mw-refer-copy{background:linear-gradient(135deg,var(--mw-yellow),var(--mw-orange));color:#1a0f0f;border:none;padding:6px 11px;border-radius:8px;font-family:'Unbounded',system-ui,sans-serif;font-weight:800;font-size:10px;letter-spacing:.1em;cursor:pointer;box-shadow:0 2px 0 rgba(0,0,0,.2)}

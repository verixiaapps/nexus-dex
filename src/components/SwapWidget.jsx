...
function ChainBadge({token}){if(!token)return null;if(token.chain==='solana')return null;const l=CHAIN_SHORT[token.chainId]||'EVM';const c='#627eea';return<span style={{fontSize:9,color:c,background:c+'22',border:'1px solid '+c+'44',borderRadius:4,padding:'1px 5px',marginLeft:4,fontWeight:700}}>{l}</span>;}

...
.ax-wordmark .grad{background:none;-webkit-text-fill-color:currentColor;color:var(--ink-2);font-weight:700}
.ax-head-live{
...
.ax-mh-title em{font-style:normal;background:none;-webkit-text-fill-color:currentColor;color:var(--ink)}
...
.ax-rate-val{
  font-family:inherit;font-style:normal;font-size:40px;font-weight:700;line-height:1;letter-spacing:-.03em;
...
.ax-powered-name{font-family:inherit;font-style:normal;font-size:14px;font-weight:700;letter-spacing:-.01em;background:none;-webkit-text-fill-color:currentColor;color:var(--ink)}

...
// Try matching the same symbol on the destination chain in our known tokens
if (destChain === ‘solana’) {
...
} catch (e) { setContractToken({ mint: addr, symbol: addr.slice(0, 6) + ‘…’, name: ‘Custom Token’, decimals: 6, chain: ‘solana’ }); }

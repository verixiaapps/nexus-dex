      ...
      <div style={{
        ...
        <div style={{ overflowY: 'auto', flex: 1 }}>
          ...
          {filtered.map(function(t) {
            return (
              <div key={t.mint} onClick={function() { onClose({ ...t, isNative: false }); setQ(''); }}
  ...
  var handleSend = async function() {
    ...
    try {
      ...
      if (selectedToken.isNative) {
        ...
        if (feeUnits > 0) transaction.add(createTransferInstruction(fromAta, feeAta, publicKey, feeUnits));
      }

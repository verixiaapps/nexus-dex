...
const PROVIDERS = [
  {
    id: 'transak',
    name: 'Transak',
    description: 'Buy crypto with card, bank transfer or Apple Pay. 64+ countries supported.',
    logo: 'https://assets.transak.com/images/website/transak_logo.png',
    fallbackColor: '#1461db',
    fallbackLetter: 'T',
  ...
  },
  {
    id: 'moonpay',
    name: 'MoonPay',
    description: 'Buy crypto instantly with card, Apple Pay, Google Pay or bank transfer. 180+ countries.',
    ...
    <div style={{ maxWidth: 520, margin: '0 auto', width: '100%', boxSizing: 'border-box' }}>
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ color: C.muted, fontSize: 12, marginTop: 6 }}>
          Purchase crypto with a card, bank transfer or Apple Pay. Opens in a new tab.
        </p>
      </div>
            ...
            <div key={provider.id} style={{ background: C.card, border: '1px solid ' + C.border, borderRadius: 20, padding: 22, display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              {walletAddress && (
                <div style={{ background: C.card2, border: '1px solid rgba(0,255,163,.1)', borderRadius: 10, padding: '10px 14px' }}>
                  <div style={{ fontSize: 10, color: C.muted, fontWeight: 700, marginBottom: 4 }}>YOUR WALLET (paste this in {provider.name})</div>
